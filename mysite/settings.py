...
# Legal document versions for consent/audit records.
MONGIKAZI_TERMS_VERSION = os.getenv("MONGIKAZI_TERMS_VERSION", "2026-05-30")
MONGIKAZI_PRIVACY_VERSION = os.getenv("MONGIKAZI_PRIVACY_VERSION", "2026-05-30")
MONGIKAZI_SAFETY_VERSION = os.getenv("MONGIKAZI_SAFETY_VERSION", "2026-05-30")
